...
```{r fig2a, echo=FALSE, fig.cap="AClass training and classification schema.", out.width='75%'}
...
```{r fig2b, echo=FALSE, fig.cap="Model selection accuracy plot: 8 algorithms vs number of genes.", out.width='75%'}
...
The result AClass object would have new slot `train.data.main` and `train.data.validate`
...
```{r figs3b, echo=FALSE, fig.cap="Example classification report output.", out.width='75%'}
...
```{r fig3d, echo=FALSE, fig.cap="MDS plot of MRT samples vs ATRT reference.", out.width='75%'}
knitr::include_graphics("figures/Fig3d.png")
```

# 6. Support for Gene expression matrix, RNASeq or GEO Data

You can adapt `df2nano()` for microarray or RNA-seq datasets. See [vignette part2](tutorial2.Rmd) for full Affymetrix demo with `GSE70678`.
